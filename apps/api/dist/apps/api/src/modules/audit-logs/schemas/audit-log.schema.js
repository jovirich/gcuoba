...
__decorate([
    ...
    __metadata("design:type", Object)
], AuditLog.prototype, "scopeType", void 0);
__decorate([
    (0, mongoose_1.Prop)({ type: String, default: null }),
    __metadata("design:type", Object)
], AuditLog.prototype, "scopeId", void 0);
__decorate([
...
exports.AuditLogSchema.index({ createdAt: -1, action: 1 });
exports.AuditLogSchema.index({ actorUserId: 1, createdAt: -1 });
exports.AuditLogSchema.index({ scopeType: 1, scopeId: 1, createdAt: -1 });
